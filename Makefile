...
runpcgcn:
	cd pcgcn; python train.py --no-cuda --rmat Magenta_Spoonbill --epochs 8 --partition metis --nparts 2;

rungcn:
	cd pcgcn; python train.py --no-cuda --rmat Magenta_Spoonbill --epochs 8 --gcn;
